...
.initial_values_of_variables_from_0x50
    ...
    equb 0                                                            ; 1e6f: 00          .
.set_clock_value
    equb   5,   0,   0,   0,   0,   0,   0,   0,   0, &ee, &e0, &0c   ; 1e70: 05 00 00... ...            ; Five byte clock value (low byte to high byte)
    equb   0,   0,   0,   0                                           ; 1e7c: 00 00 00... ...
