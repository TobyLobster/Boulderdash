...
comment(0x24b6, "get below left cell", indent=1)
comment(0x24c0, "get below right cell", indent=1)
label(0x24c6, "below_left_or_right_is_empty")
comment(0x24cc, "below left or right is set to $80, still a space, but marked as unprocessed", indent=1)
comment(0x24c9, "Store in either cell_below_left or cell_below right depending on Y=$80 or $82, since $fff6 = cell_below_left - $80", indent=1)
label(0x24d0, "set_to_space")
ab(0x24d2, True)
label(0x24d4, "space_below_is_also_a_space")
comment(0x24d4, "set bit six of the cell below to indicate cell above is also a space", indent=1)
ab(0x24d9, True)
...
comment(0x24ee, "store $4b or $4c in location $4b or $4c. i.e. activate sound5_active_flag or sound6_active_flag", indent=1)
