...
ret(0x23db)
unused(0x23dc)
comment(0x23e0, "Handler for filling in a vertical strip. Set the cells between $0b's to the value above the first $0b.")
...
for i in range(20):
    ...
    decimal(0x4c54 + i)
ten_by_two(0x4c40)
ten_by_two(0x4c54, "fungus_growth_intervals")
